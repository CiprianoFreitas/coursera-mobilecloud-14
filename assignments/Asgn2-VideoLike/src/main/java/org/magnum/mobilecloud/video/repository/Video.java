...
public class Video {
    ...
    public boolean containsLikeByUser(String username) {
        return likesUsernames.contains(username);
    }

    public void addLikeByUser(String username) {
        likesUsernames.add(username);
        likes = likesUsernames.size();
    }

    public void removeLikeByUser(String username) {
